...
OpenLab software and instructions: https://github.com/geekscape/aiko_arduinolab
...
BLOCK DIAGRAM: Screen (GLCD), navigation buttons, potentiometers, inputs/output
               Event handlers set-up and invocation, Aiko time-based events
